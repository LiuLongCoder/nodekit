module.exports = {
  URL_User_Register: '/money/v1/user/register', // 注册用户
  URL_User_Login: '/money/v1/user/login', // 用户登录
  URL_User_GetUserInfo: '/money/v1/user/getUserInfo', // 获取用户信息
  URL_User_ModifyPassword: '/money/v1/user/modifyPwd', // 用户修改密码
  URL_User_ModifyInfo: '/money/v1/user/modifyInfo', // 用户修改信息
  ...
  URL_User_AddPayRecord: '/money/v1/user/addPayRecord', // 添加刷卡记录
  URL_User_GetPayRecordList: '/money/v1/user/getPayRecordList', // 获取刷卡记录
  URL_User_DeletePayRecord: '/money/v1/user/deletePayRecord', // 删除刷卡记录
